...
tab2 = pd.DataFrame({'formulation': '2obj_static', 'annRev': subset['annRev'], 'maxDebt': subset['maxDebt'], 
                     'maxComplex': subset['maxComplex'], 'maxFund': subset['maxFund']}, index=[0])

subset = ref_dps_2obj_retest.iloc[min_dist[1], :]
tab2 = tab2.append(pd.DataFrame({'formulation': '2obj_dynamic', 'annRev': subset['annRev'], 'maxDebt': subset['maxDebt'], 
...
# # p1 = ax.scatter(xs, ys, zs, s=ss, marker='v', alpha=0.6, c=col_blues[2],zorder=2)
# # p1 = ax.scatter(x_min_dist[0], y_min_dist[0], z_min_dist[0], s=s_min_dist[0], marker='v', alpha=1, c=col_blues[0],zorder=3)
...
# # p1 = ax.scatter(xs, ys, zs, s=ss, marker='^',alpha=0.6, c=col_reds[2],zorder=3)
# # p1 = ax.scatter(x_min_dist[1], y_min_dist[1], z_min_dist[1], s=s_min_dist[1], marker='^', alpha=1, c=col_reds[0], zorder=0)
...
tab2 = tab2.append(pd.DataFrame({'formulation': '4obj_dynamic_2objNonDom', 'annRev': subset['annRev'], 'maxDebt': subset['maxDebt'], 
                                 'maxComplex': subset['maxComplex'], 'maxFund': subset['maxFund']}, index=[2]))
